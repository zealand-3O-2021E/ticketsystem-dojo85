...
namespace StorebaeltLibraryTests
{
    ...
    public class CarClassTests
    {
        ...
        private static IEnumerable<object[]> GetDynamicTestData()
        {
            ...
            yield return new object[] { new Car() {Date = new DateTime(2021, 09, 13)}, 240.00 };
            //Friday, with Brobizz
            yield return new object[] { new Car(true) { Date = new DateTime(2021, 09, 17) }, 228.00 };
            //Saturday and Sunday, without Brobizz
            yield return new object[] { new Car() { Date = new DateTime(2021, 09, 18) }, 192.00 };
            yield return new object[] { new Car() { Date = new DateTime(2021, 09, 19) }, 192.00 };
            //Saturday and Sunday, with Brobizz
            yield return new object[] { new Car(true) { Date = new DateTime(2021, 09, 18) }, 182.40 };
            yield return new object[] { new Car(true) { Date = new DateTime(2021, 09, 19) }, 182.40 };
        }
    }
}
